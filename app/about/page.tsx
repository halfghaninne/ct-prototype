    ...
    return (
        <div className={styles.center}>
            <div className={`${styles.aboutIntro} ${styles.paraSpacing}`}>
                <p className={`${styles.about1}`} id='about1'>What would it mean for communities in diaspora to learn from our own textual histories through the act of communal translation?</p>
                
                <p className={styles.about2} id='about2'>How can we apply and extend these translation practices as a means of moving beyond the static nature of the digital archive?</p>
            ...
            <p>Many existing software translation tools seem primarily concerned with translation at scale<sup>2</sup> — translating many texts or into many languages,<sup>3</sup> or crowdsourcing translations,<sup>4</sup> or building translational memory<sup>5</sup> over many different translations.</p>
            
            <p>This proposal differs fundamentally in that it is as equally concerned with the <em>process</em> of translation as it is with the product of that translation. The project centers on a theory of the political and pedagogical uses of communal translation, largely inspired by The Palestinian Youth Movement's translation of <em>The Trinity of Fundamentals</em>.<sup>6</sup></p>
            
            <p>The project aims to create a place for members to work and decide on translations together, and to treat the process of translation as its own important text.</p>

            <p>This project was conceived over the course of my graduate studies in CL89400 Introduction to Translation and DHUM78000 Digital Memories. Initially imagined as a customization of cultural management system, Dédalo,<sup>7</sup> I've instead opted for building the platform from scratch. While this has delayed development progress significatnly, it also allows me to make more customizations at every step of the software development process, like making security-minded decisions for the content data layer.<sup>8</sup></p>
            </div>
